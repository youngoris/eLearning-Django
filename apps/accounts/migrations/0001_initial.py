    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher')], default='student', max_length=7, verbose_name='User Type')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='user/avatars/', verbose_name='Avatar')),
                ('real_name', models.CharField(blank=True, max_length=100, verbose_name='Real Name')),
